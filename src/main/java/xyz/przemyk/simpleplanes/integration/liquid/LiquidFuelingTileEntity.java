...
//            final Integer cost = Config.INSTANCE.LAVA_COST.get();
...
//                    if (planeEntity.getFuel() <= Config.INSTANCE.LAVA_MAX_FUEL.get() - Config.INSTANCE.LAVA_FLY_TICKS.get()) {
//                        if (action.simulate()) {
//                            i += cost;
//                        } else {
//                            final int amount = resource.getAmount();
//                            if (cost <= amount) {
//                                planeEntity.addFuel(Config.INSTANCE.LAVA_FLY_TICKS.get());
//                                resource.shrink(cost);
//                                i += cost;
//                            } else if (amount > 0) {
//                                resource.shrink(amount);
//                                i += amount;
//                                planeEntity.addFuel((Config.INSTANCE.LAVA_FLY_TICKS.get() / cost) * amount);
//                            }
//                        }
//                    } else {
