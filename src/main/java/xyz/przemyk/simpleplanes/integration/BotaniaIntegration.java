...
//                boolean got_mana = ManaItemHandler.INSTANCE.getValue().requestManaExactForTool(itemStack, player, Config.INSTANCE.MANA_COST.get(), true);
//                if (got_mana) {
//                    planeEntity.addFuelMaxed(Config.INSTANCE.FLY_TICKS_PER_MANA.get());
//                }
//            }
//            return false;
//        }
