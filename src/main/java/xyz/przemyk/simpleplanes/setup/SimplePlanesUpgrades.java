...
public class SimplePlanesUpgrades
{
    ...
    public static final RegistryObject<UpgradeType> SPRAYER =
            UPGRADE_TYPES.register("sprayer", () ->
                    new UpgradeType(SimplePlanesItems.SPRAYER.get(), SprayerUpgrade::new, planeEntity -> !(planeEntity instanceof HelicopterEntity)));
    ...
    public static final RegistryObject<UpgradeType> BOOSTER = UPGRADE_TYPES
            .register("booster", () -> new UpgradeType(SimplePlanesItems.BOOSTER.get(), RocketUpgrade::new, planeEntity -> !planeEntity.isLarge()));
    public static final RegistryObject<UpgradeType> SHOOTER = UPGRADE_TYPES
            .register("shooter", () -> new UpgradeType(SimplePlanesItems.SHOOTER.get(), ShooterUpgrade::new));
    ...
    public static final RegistryObject<UpgradeType> FOLDING = UPGRADE_TYPES.register("folding", () -> new UpgradeType.Custom(
            itemStack -> itemStack.getItem() == Items.ELYTRA && EnchantmentHelper.getEnchantmentLevel(Enchantments.MENDING, itemStack) > 0,
            FoldingUpgrade::new));
