...
//    public static final RegistryObject<PlaneItem> PLANE = ITEMS.register("oak_plane", () -> new PlaneItem(new Item.Properties().group(SIMPLE_PLANES_ITEM_GROUP), world -> new PlaneEntity(SimplePlanesEntities.PLANE, world)));
//    public static final RegistryObject<PlaneItem> SPRUCE_PLANE = ITEMS.register("spruce_plane", () -> new PlaneItem(new Item.Properties().group(SIMPLE_PLANES_ITEM_GROUP), world -> new PlaneEntity(SimplePlanesEntities.SPRUCE_PLANE.get(), world)));
//    public static final RegistryObject<PlaneItem> BIRCH_PLANE = ITEMS.register("birch_plane", () -> new PlaneItem(new Item.Properties().group(SIMPLE_PLANES_ITEM_GROUP), world -> new PlaneEntity(SimplePlanesEntities.BIRCH_PLANE.get(), world)));
//    public static final RegistryObject<PlaneItem> JUNGLE_PLANE = ITEMS.register("jungle_plane", () -> new PlaneItem(new Item.Properties().group(SIMPLE_PLANES_ITEM_GROUP), world -> new PlaneEntity(SimplePlanesEntities.JUNGLE_PLANE.get(), world)));
//    public static final RegistryObject<PlaneItem> ACACIA_PLANE = ITEMS.register("acacia_plane", () -> new PlaneItem(new Item.Properties().group(SIMPLE_PLANES_ITEM_GROUP), world -> new PlaneEntity(SimplePlanesEntities.ACACIA_PLANE.get(), world)));
//    public static final RegistryObject<PlaneItem> DARK_OAK_PLANE = ITEMS.register("dark_oak_plane", () -> new PlaneItem(new Item.Properties().group(SIMPLE_PLANES_ITEM_GROUP), world -> new PlaneEntity(SimplePlanesEntities.DARK_OAK_PLANE.get(), world)));
//    public static final RegistryObject<PlaneItem> CRIMSON_PLANE = ITEMS.register("crimson_plane", () -> new PlaneItem(new Item.Properties().group(SIMPLE_PLANES_ITEM_GROUP), world -> new PlaneEntity(SimplePlanesEntities.CRIMSON_PLANE.get(), world)));
//    public static final RegistryObject<PlaneItem> WARPED_PLANE = ITEMS.register("warped_plane", () -> new PlaneItem(new Item.Properties().group(SIMPLE_PLANES_ITEM_GROUP), world -> new PlaneEntity(SimplePlanesEntities.WARPED_PLANE.get(), world)));
//
//    public static final RegistryObject<PlaneItem> OAK_LARGE_PLANE = ITEMS.register("oak_large_plane", () -> new PlaneItem(new Item.Properties().group(SIMPLE_PLANES_ITEM_GROUP), world -> new LargePlaneEntity(SimplePlanesEntities.OAK_LARGE_PLANE.get(), world)));
//    public static final RegistryObject<PlaneItem> SPRUCE_LARGE_PLANE = ITEMS.register("spruce_large_plane", () -> new PlaneItem(new Item.Properties().group(SIMPLE_PLANES_ITEM_GROUP), world -> new LargePlaneEntity(SimplePlanesEntities.SPRUCE_LARGE_PLANE.get(), world)));
//    public static final RegistryObject<PlaneItem> BIRCH_LARGE_PLANE = ITEMS.register("birch_large_plane", () -> new PlaneItem(new Item.Properties().group(SIMPLE_PLANES_ITEM_GROUP), world -> new LargePlaneEntity(SimplePlanesEntities.BIRCH_LARGE_PLANE.get(), world)));
//    public static final RegistryObject<PlaneItem> JUNGLE_LARGE_PLANE = ITEMS.register("jungle_large_plane", () -> new PlaneItem(new Item.Properties().group(SIMPLE_PLANES_ITEM_GROUP), world -> new LargePlaneEntity(SimplePlanesEntities.JUNGLE_LARGE_PLANE.get(), world)));
//    public static final RegistryObject<PlaneItem> ACACIA_LARGE_PLANE = ITEMS.register("acacia_large_plane", () -> new PlaneItem(new Item.Properties().group(SIMPLE_PLANES_ITEM_GROUP), world -> new LargePlaneEntity(SimplePlanesEntities.ACACIA_LARGE_PLANE.get(), world)));
//    public static final RegistryObject<PlaneItem> DARK_OAK_LARGE_PLANE = ITEMS.register("dark_oak_large_plane", () -> new PlaneItem(new Item.Properties().group(SIMPLE_PLANES_ITEM_GROUP), world -> new LargePlaneEntity(SimplePlanesEntities.DARK_OAK_LARGE_PLANE.get(), world)));
//    public static final RegistryObject<PlaneItem> CRIMSON_LARGE_PLANE = ITEMS.register("crimson_large_plane", () -> new PlaneItem(new Item.Properties().group(SIMPLE_PLANES_ITEM_GROUP), world -> new LargePlaneEntity(SimplePlanesEntities.CRIMSON_LARGE_PLANE.get(), world)));
//    public static final RegistryObject<PlaneItem> WARPED_LARGE_PLANE = ITEMS.register("warped_large_plane", () -> new PlaneItem(new Item.Properties().group(SIMPLE_PLANES_ITEM_GROUP), world -> new LargePlaneEntity(SimplePlanesEntities.WARPED_LARGE_PLANE.get(), world)));
//
