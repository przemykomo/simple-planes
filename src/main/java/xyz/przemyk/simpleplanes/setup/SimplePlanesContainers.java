...
public class SimplePlanesContainers {
    ...
    public static final MenuType<RemoveUpgradesContainer> UPGRADES_REMOVAL = register("upgrades_removal", new ExtendedScreenHandlerType<>(RemoveUpgradesContainer::new));
