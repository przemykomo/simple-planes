...
public class SimplePlanesEntities {
    ...
    public static final RegistryObject<LargePlaneEntityType> SPRUCE_LARGE_FURNACE_PLANE = ENTITIES.register("spruce_large_furnace_plane", () -> new LargePlaneEntityType(SimplePlanesItems.SPRUCE_LARGE_FURNACE_PLANE.get(), new ResourceLocation(SimplePlanesMod.MODID, "textures/entity/plane/large_furnace/spruce.png"), new ResourceLocation(SimplePlanesMod.MODID, "textures/entity/plane/large_furnace_powered/spruce.png"), false));
    public static final RegistryObject<LargePlaneEntityType> BIRCH_LARGE_FURNACE_PLANE = ENTITIES.register("birch_large_furnace_plane", () -> new LargePlaneEntityType(SimplePlanesItems.BIRCH_LARGE_FURNACE_PLANE.get(), new ResourceLocation(SimplePlanesMod.MODID, "textures/entity/plane/large_furnace/birch.png"), new ResourceLocation(SimplePlanesMod.MODID, "textures/entity/plane/large_furnace_powered/birch.png"), false));
    public static final RegistryObject<LargePlaneEntityType> JUNGLE_LARGE_FURNACE_PLANE = ENTITIES.register("jungle_large_furnace_plane", () -> new LargePlaneEntityType(SimplePlanesItems.JUNGLE_LARGE_FURNACE_PLANE.get(), new ResourceLocation(SimplePlanesMod.MODID, "textures/entity/plane/large_furnace/jungle.png"), new ResourceLocation(SimplePlanesMod.MODID, "textures/entity/plane/large_furnace_powered/jungle.png"), false));
    public static final RegistryObject<LargePlaneEntityType> ACACIA_LARGE_FURNACE_PLANE = ENTITIES.register("acacia_large_furnace_plane", () -> new LargePlaneEntityType(SimplePlanesItems.ACACIA_LARGE_FURNACE_PLANE.get(), new ResourceLocation(SimplePlanesMod.MODID, "textures/entity/plane/large_furnace/acacia.png"), new ResourceLocation(SimplePlanesMod.MODID, "textures/entity/plane/large_furnace_powered/acacia.png"), false));
    public static final RegistryObject<LargePlaneEntityType> DARK_OAK_LARGE_FURNACE_PLANE = ENTITIES.register("dark_oak_large_furnace_plane", () -> new LargePlaneEntityType(SimplePlanesItems.DARK_OAK_LARGE_FURNACE_PLANE.get(), new ResourceLocation(SimplePlanesMod.MODID, "textures/entity/plane/large_furnace/dark_oak.png"), new ResourceLocation(SimplePlanesMod.MODID, "textures/entity/plane/large_furnace_powered/dark_oak.png"), false));
    public static final RegistryObject<LargePlaneEntityType> CRIMSON_LARGE_FURNACE_PLANE = ENTITIES.register("crimson_large_furnace_plane", () -> new LargePlaneEntityType(SimplePlanesItems.CRIMSON_LARGE_FURNACE_PLANE.get(), new ResourceLocation(SimplePlanesMod.MODID, "textures/entity/plane/large_furnace/crimson.png"), new ResourceLocation(SimplePlanesMod.MODID, "textures/entity/plane/large_furnace_powered/crimson.png"), true));
    public static final RegistryObject<LargePlaneEntityType> WARPED_LARGE_FURNACE_PLANE = ENTITIES.register("warped_large_furnace_plane", () -> new LargePlaneEntityType(SimplePlanesItems.WARPED_LARGE_FURNACE_PLANE.get(), new ResourceLocation(SimplePlanesMod.MODID, "textures/entity/plane/large_furnace/warped.png"), new ResourceLocation(SimplePlanesMod.MODID, "textures/entity/plane/large_furnace_powered/warped.png"), true));
