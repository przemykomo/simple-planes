...
public class BannerModel {
    ...
    public static void renderBanner(PlaneEntity planeEntity, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, ItemStack banner, int packedLight, ModelRenderer modelRenderer) {
//		if(true)return;
        if (!banner.isEmpty()) {
            matrixStackIn.push();
            ...
            float r = (-0.0125F + 0.05F * MathHelper.cos(f2 / 5)) * (float) 180;
