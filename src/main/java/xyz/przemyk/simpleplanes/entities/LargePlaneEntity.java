...
public class LargePlaneEntity extends PlaneEntity
{
    ...
    @Override protected float getGroundPitch()
    {
        return 10;
    }
    ...
    @Override protected Item getItem()
    {
    ...
    protected void spawnSmokeParticles(int fuel)
    {
        ...
        serverWorld.spawnParticle(ParticleTypes.SMOKE, getPosX() - (2 * front.x), getPosY() + 1.0, getPosZ() - (2 * front.y), 0, 0, 0, 0, 0.0);
        if (fuel > 4 && fuel < 100)
        {
