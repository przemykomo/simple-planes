...
//    private final List<PlaneWorkbenchRecipe> recipeList;
    ...
    public PlaneWorkbenchContainer(int id, Inventory playerInventory, BlockPos blockPos, Container itemHandler, DataSlot selectedRecipe) {
...
//        }
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(usabilityTest, playerIn, SimplePlanesBlocks.PLANE_WORKBENCH_BLOCK);
    }
